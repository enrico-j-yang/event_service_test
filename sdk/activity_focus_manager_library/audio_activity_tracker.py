...
class AudioActivityTracker(object):
    '''
    音频焦点管理类
    '''

    AUDIOACTIVITYTRACKER_CAPABILITY_INTERFACE_TYPE = "AlexaInterface"
    AUDIOACTIVITYTRACKER_CAPABILITY_INTERFACE_NAME = "AudioActivityTracker"
    AUDIOACTIVITYTRACKER_CAPABILITY_INTERFACE_VERSION = "1.0"
    ...
    def __init__(self, iflyos):
        ...
        '''
        self.namespace = 'AudioActivityTracker'
        self.iflyos = iflyos
    ...
    def get_capability_configuration(self):
        config_map = {}
        config_map[Capabilities.CAPABILITY_INTERFACE_TYPE_KEY] = self.AUDIOACTIVITYTRACKER_CAPABILITY_INTERFACE_TYPE
        config_map[Capabilities.CAPABILITY_INTERFACE_NAME_KEY] = self.AUDIOACTIVITYTRACKER_CAPABILITY_INTERFACE_NAME
        config_map[
            Capabilities.CAPABILITY_INTERFACE_VERSION_KEY] = self.AUDIOACTIVITYTRACKER_CAPABILITY_INTERFACE_VERSION
    ...
    def _execute_provide_state(self, state_request_token):
        for channel_state in self.channel_states:
            ...
            context_json[self.INTERFACE_KEY] = channel_context.interface_name
            context_json[self.IDLE_TIME_KEY] = idle_time
